...
namespace BussinessLogic
{
    public class DiagramInformation
    {
        ...
        public DiagramInformation(string titleFromGui, int intervalXFromGui, int IntervalYFromGui, int divisionsXFromGui, int divisionsYFromGui, int intervalStepFromGui)
        {
            Title = titleFromGui;
            ...
            IntervalStep = intervalStepFromGui;
