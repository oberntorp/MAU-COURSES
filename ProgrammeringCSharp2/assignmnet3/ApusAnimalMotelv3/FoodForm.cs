...
namespace ApusAnimalMotel
{
    public partial class FoodForm : Form
    {
        ...
        private void UpdateIngredientsListBox(ListManager<string> ingredients)
        {
            ClearIngredientsAddedListBox();
            for (int i = 0; i < ingredients.Count; i++)
            {
                AddedIngredientsListBox.Items.Add(ingredients.GetAt(i));
            }
        }
        ...
        {
            if(recipe.Ingredients.DeleteAt(AddedIngredientsListBox.SelectedIndex))
            {
                MessageBoxButtons buttons = MessageBoxButtons.YesNo;
        ...
        private void ChangeIngredientButton_Click(object sender, EventArgs e)
        {
            ...
            {
                recipe.Ingredients.ChangeAt(NameOfIngredientTextBox.Text, changeAt);
            }
